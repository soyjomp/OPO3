const TEST_ID = "2026_c2_parcsijardins"; 
const questions = [
  {
    number: 1,
  ...
  },
  {
    ...
    answers: [
      { text: "Avançar en la igualtat d’oportunitats entre dones i homes, tenint en compte les diferents dimensions de la desigualtat.", correct: true },
      { text: "Garantir que tots els treballadors i treballadores rebin exactament el mateix salari.", correct: false },
      { text: "Promoure activitats socials per millorar l’ambient laboral.", correct: false },
      { text: "Crear un pla exclusiu per a la contractació de personal jove.", correct: false }
    ]
  },
  {
    number: 16,
    ...
    answers: [
      { text: "Una forma de parlar que evita utilitzar verbs.", correct: false },
      { text: "Un estil comunicatiu que recomana utilitzar sempre les mateixes paraules.", correct: false },
      { text: "Un llenguatge que evita el biaix cap a un sexe i que tracta tothom amb el mateix respecte.", correct: true },
      { text: "Un llenguatge que només s’utilitza en àmbits acadèmics.", correct: false }
    ]
  },
  {
    number: 18,
  ...
  {
    number: 21,
    question: "Quan en una sol·licitud, escrit o comunicació hi figurin diversos interessats:",
    answers: [
      { text: "Les actuacions s'han d'efectuar amb l'interessat que figuri en primer terme.", correct: false },
      { text: "Les actuacions s'han d'efectuar amb el representant o l'interessat que s'hagi assenyalat expressament i, si no n'hi ha, amb el que figuri en primer terme.", correct: true },
      { text: "Les actuacions s'han d'entendre amb tots els individus.", correct: false },
  ...
  {
    number: 26,
    question: "Si el 7 de setembre es publica una resolució que inicia el termini d’esmenes de 10 dies hàbils, quin és el darrer dia vàlid per presentar una esmena?",
    answers: [
  ...
  {
    number: 27,
    question: "Si el 10 d’octubre es publica una convocatòria que inicia el termini de presentació de sol·licituds de 20 dies naturals, quin és el darrer dia vàlid per presentar una sol·licitud?",
    answers: [
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Permet posar diferents adreces, de manera que els destinataris vegin els altres.", correct: true },
      { text: "Permet posar diferents adreces, de manera que els destinataris no vegin els altres.", correct: false },
