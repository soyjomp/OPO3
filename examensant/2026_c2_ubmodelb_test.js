...
const questions = [
  ...
  },
  {
    ...
    answers: [
      { text: "En la convocatòria es pot establir una fase de prova, que no tindrà caràcter selectiu.", correct: false },
      { text: "En la convocatòria es pot establir una fase de prova, que podrà tenir caràcter selectiu.", correct: true },
      { text: "En la convocatòria es pot establir una fase de prova que, necessàriament, haurà d’anar precedida d’un curs de formació.", correct: false },
  ...
  {
    number: 7,
    question: "En la delegació de competències (art. 9 Llei 40/2015), quina afirmació és correcta?",
    answers: [
      { text: "La titularitat passa a l'òrgan delegat.", correct: false },
      { text: "Les resolucions s'entenen dictades per l'òrgan delegant.", correct: true },
      { text: "No és necessari que es publiqui.", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Es produeix en casos de vacant, absència o malaltia.", correct: true },
      { text: "Implica trasllat definitiu de titularitat.", correct: false },
      { text: "Només entre universitats diferents.", correct: false },
      { text: "Requereix aprovació del Claustre.", correct: false }
    ]
  },
  {
    number: 16,
    question: "L'acte pel qual un òrgan superior assumeix un assumpte d’un inferior és:",
    answers: [
  ...
  {
    number: 17,
    question: "Els actes administratius seran objecte de publicació quan:",
    answers: [
      { text: "Ho decideixi l'Administració.", correct: false },
      { text: "L'acte sigui desfavorable.", correct: false },
      { text: "Tinguin una pluralitat indeterminada de destinataris.", correct: true },
      { text: "Siguin sancionadors.", correct: false }
    ]
  },
  {
    number: 18,
    question: "Finalitat del Portal de la Transparència (Llei 19/2014):",
    answers: [
      { text: "Permetre sol·licituds presencials.", correct: false },
      { text: "Centralitzar la informació per garantir transparència.", correct: true },
      { text: "Publicar només normativa.", correct: false },
      { text: "Gestionar expedients interns.", correct: false }
    ]
  },
  {
    number: 19,
    ...
    answers: [
      { text: "Amb la publicació al BOE.", correct: false },
      { text: "Amb la notificació.", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Correu postal.", correct: false },
      { text: "Publicació al diari oficial.", correct: false },
      { text: "Mitjans electrònics.", correct: true },
      { text: "Tauler d'anuncis.", correct: false }
    ]
  },
  {
    number: 21,
    ...
    answers: [
      ...
      { text: "Per Grup/Subgrup i triennis.", correct: false },
      { text: "Per Grup/Subgrup, triennis i complements.", correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: "Si el signa un funcionari en pràctiques.", correct: false },
      { text: "Si falta firma electrònica.", correct: false },
      { text: "Si manquen requisits per assolir la fi o produeixin indefensió.", correct: true },
  ...
  {
    number: 27,
    question: "El Registre Electrònic General ha de permetre presentar documents:",
    answers: [
      { text: "Dilluns a divendres 9h-14h.", correct: false },
      { text: "Tots els dies 24 hores.", correct: true },
      { text: "Només dies hàbils.", correct: false },
      { text: "Si pesen menys d'1 MB.", correct: false }
    ]
  },
  {
    number: 28,
  ...
  {
    number: 30,
    question: "El Portal de la Transparència ha de garantir informació:",
    answers: [
  ...
  },
  {
    ...
    answers: [
      ...
      { text: "Vàlid.", correct: false },
      { text: "Irrellevant.", correct: false }
    ]
  },
  {
    number: 40,
